...
static Gimbal_InputMode_t s_input_mode;
...
{
    s_input_mode = GIMBAL_INPUT_MANUAL;
...
{
    s_yaw_axis.target_angle = yaw_angle;
    s_pitch_axis.target_angle = pitch_angle;
}
...
#if !GIMBAL_PITCH_SPEED_TUNING_MODE
    if (s_input_mode == GIMBAL_INPUT_MANUAL)
    {
